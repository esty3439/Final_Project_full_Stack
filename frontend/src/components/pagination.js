  ...
  return (
    <div className="flex items-center justify-center gap-4 mt-6 max-md:gap-2">
      ...
      <IconButton
        ...
        disabled={page <= 1}
        className={`transition-all duration-200 rounded-lg p-2 max-md:p-1 border-2 ${page <= 1
      ...
      <IconButton
        ...
        className={`transition-all duration-200 rounded-lg p-2 max-md:p-1 border-2 ${page >= (totalPages || 1)
            ? "border-gray-300 text-gray-300 cursor-not-allowed"
            : "border-green-400 text-green-600 hover:bg-green-100 hover:border-green-500"
          }`}
      >
