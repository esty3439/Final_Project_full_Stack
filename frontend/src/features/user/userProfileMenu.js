    ...
    <div ref={menuRef} className="relative inline-block text-right max-md:text-sm">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-44 max-md:w-36 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
          <button
            onClick={goToProfile}
            className="flex text-xl items-center gap-2 w-full px-4 py-2 max-md:px-3 max-md:py-1 text-gray-700 hover:bg-gray-100 rounded-t-lg"
          >
          ...
          <button
            ...
            className="flex text-xl items-center gap-2 w-full px-4 py-2 max-md:px-3 max-md:py-1 text-red-600 hover:bg-red-50 rounded-b-lg"
          >
